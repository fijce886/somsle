...
const char *segment1 = "V2";
const char *segment2 = "F0";
const char *segment3 = "ZXJ";
const char *segment4 = "tYX";
const char *segment5 = "JrOi";
const char *segment6 = "BXYXR";
const char *segment7 = "lcm1h";
const char *segment8 = "cms6I";
const char *segment9 = "FRoaX";
const char *segment10 = "MgZml";
const char *segment11 = "sZSB";
const char *segment12 = "pcyB";
const char *segment13 = "tYWRl";
const char *segment14 = "IGJ5I";
const char *segment15 = "FJJU0";
const char *segment16 = "hJCk9";
const char *segment17 = "XTkVSIE9GIENIQU5ORUwgQU5EIEZJTEUgOi0gQExFR0lUQUNDUyAsIEBSaXNoaTc0NwpUSElTIEZJTEUgSVMgQ0xPU0VEIE5PVyA=";
...
int main(int argc, char *argv[]) {
    ...
    const char *encoded_watermark = "V2F0ZXJtYXJrOiBXYXRlcm1hcms6IFRoaXMgZmlsZSBpcyBtYWRlIGJ5IFJJU0hJCk9XTkVSIE9GIENIQU5ORUwgQU5EIEZJTEUgOi0gQExFR0lUQUNDUyAsIEBSaXNoaTc0NwpUSElTIEZJTEUgSVMgQ0xPU0VEIE5PVyA=";
